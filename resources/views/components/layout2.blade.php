        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="{{route('home')}}"><img src="{{asset('images/frame-mingle-studio-logo.png')}}" class="logo img-fluid" style="max-width:100px;"  alt="" ></a>
                </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12">
                    <div class="footer-link">
                        ...
                        <ul>
                            ...
                            <li></i><a href={{route('terms')}}>Terms &amp; Conditions</a></li>
                            <li></i><a href={{route('privacy')}}>Privacy Policy</a></li>
