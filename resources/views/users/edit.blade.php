        ...
        <div class="container">
            <div class="row new-account-login">
                ...
                <div class="col-sm-6 col-lg-6 mb-3">
                    ...
                    <form class="mt-3 review-form-box" id="formRegister" method="POST" action="{{ route('users.edit', $user) }}">
                        @csrf
                        @method('PUT')
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="name" class="mb-0">Edit your name</label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="InputEmail1" class="mb-0">Edit your email Address</label>
                                <input type="email" name="email" class="form-control" id="InputEmail1"  value={{$user->email}} placeholder="">
                                @error('email')
                                    <p class="text-red-500 text-xs mt-1">{{$message}}</p>
                                @enderror
                            </div>
                            <div class="form-group col-md-6">
                                <label for="InputPassword1" class="mb-0">New Password</label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="InputPassword2" class="mb-0">Confirm New Password</label>
                        ...
                        <button class="btn hvr-hover">Update</button>
                    </form>
                </div>
            </div>
            <!-- <div class="row">
